...
# Source: https://github.com/deepmind/deepmind-research/blob/master/learning_to_simulate/reading_utils.py
...
def parse_serialized_simulation_example(example_proto):
    ...
    tf.debugging.assert_all_finite(parsed_features['velocity'], 'Infinity found in dataset')
